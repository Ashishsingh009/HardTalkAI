...
- [ ] Host the privacy policy on **public HTTPS**. Live Static Space: `https://bhaiashish-hardtalkai.static.hf.space/privacy.html` ([docs/huggingface-space.md](huggingface-space.md)). FastAPI `/privacy` needs a Docker Space (PRO) or another host. Blob URL is a stopgap: `https://github.com/Ashishsingh009/HardTalkAI/blob/main/docs/privacy-policy.md`
