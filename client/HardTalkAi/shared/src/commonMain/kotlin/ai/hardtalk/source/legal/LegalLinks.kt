...
object LegalLinks {
    ...
    const val LAST_UPDATED = "13 September 2026"
    ...
    val SUMMARY =
        "HardTalkAI is a prototype career-coaching practice app (Coach Heather). " +
            ...
            "on our server. Android may unlock extra drills with a Play purchase through " +
            "RevenueCat (HardTalk Pro). We do not sell personal information or run ads. " +
            "Chats are not written to a database in this prototype. Contact " +
            "$CONTACT_EMAIL, or $CONTACT_FALLBACK_EMAIL if that inbox is not monitored yet."
}
